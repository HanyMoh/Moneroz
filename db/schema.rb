...
ActiveRecord::Schema.define(version: 20180427140249) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "doc_items", id: :serial, force: :cascade do |t|
    ...
    t.index ["document_id"], name: "index_doc_items_on_document_id"
    t.index ["product_id"], name: "index_doc_items_on_product_id"
  end
  ...
  create_table "documents", id: :serial, force: :cascade do |t|
    ...
    t.index ["store_id"], name: "index_documents_on_store_id"
  ...
  create_table "payments", id: :serial, force: :cascade do |t|
    ...
    t.index ["storage_id"], name: "index_payments_on_storage_id"
  ...
  create_table "products", id: :serial, force: :cascade do |t|
    ...
    t.index ["unit_refill_id"], name: "index_products_on_unit_refill_id"
  end
  ...
  create_table "sys_transactions", id: :serial, force: :cascade do |t|
